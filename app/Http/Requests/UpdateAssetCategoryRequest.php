...
class UpdateAssetCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['required', 'string', 'max:255', Rule::unique('asset_categories', 'name')->ignore($category)],
            'code' => ['nullable', 'string', 'max:10', Rule::unique('asset_categories', 'code')->ignore($category)],
