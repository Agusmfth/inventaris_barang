...
class UpdateAssetLocationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['required', 'string', 'max:255', Rule::unique('asset_locations', 'name')->ignore($location)],
            'code' => ['required', 'string', 'max:20', Rule::unique('asset_locations', 'code')->ignore($location)],
