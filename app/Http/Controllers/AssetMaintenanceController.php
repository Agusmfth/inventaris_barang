...
class AssetMaintenanceController extends Controller
{
    ...
    {
        $filters = $request->validate(['search'=>['nullable','string','max:100'], 'status'=>['nullable','in:menunggu,diproses,selesai,dibatalkan'], 'condition'=>['nullable','in:baik,rusak_ringan,rusak_berat'], 'date'=>['nullable','date'], 'location'=>['nullable','integer','exists:asset_locations,id']]);
        $maintenances = AssetMaintenance::with(['asset.location:id,name'])
            ...
            ->latest('reported_date')->latest('id')->paginate(10)->withQueryString();
